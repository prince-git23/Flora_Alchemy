  ...
  return (
    <AdminLayout>
      <div className="max-w-7xl mx-auto space-y-8 pb-16">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div className="space-y-1.5">
              <div className="flex items-center gap-1.5 text-[13px] text-[var(--color-botanical-subtle)]">
                ...
                <span>Settings</span>
                <span className="text-[#d1c4bd]">/</span>
                <span className="text-[var(--color-botanical-primary)] font-semibold">General</span>
              </div>
              ...
              <p className="text-[15px] text-[var(--color-botanical-muted)] max-w-2xl">
            ...
            <div className="flex items-center gap-3 self-start md:self-auto bg-[var(--color-surface-low)] px-4 py-2.5 rounded-2xl shadow-xs border border-[var(--color-botanical-border)]">
              ...
              <div className="flex flex-col text-left leading-tight">
                <span className="text-[10px] uppercase font-bold tracking-wider text-[var(--color-botanical-subtle)]">Current State</span>
                <span className="text-[13px] font-semibold text-[var(--color-botanical-primary)]">
        ...
        <aside className="sticky top-16 z-20 p-4 md:px-6 rounded-2xl bg-[var(--color-surface-lowest)]/95 backdrop-blur-md shadow-md border border-[var(--color-botanical-border)] flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <section className="bg-[var(--color-surface-lowest)] rounded-2xl p-6 sm:p-8 shadow-[0_4px_20px_-2px_rgba(46,36,30,0.04)] border border-[var(--color-botanical-border)] space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1.5">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Store Name</label>
              <input
                type="text"
            ...
            <div className="space-y-1.5">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Store Headline &amp; Bio</label>
              <input
                type="text"
            ...
            <div className="space-y-1.5">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Contact Email Address</label>
              <input
                type="email"
            ...
            <div className="space-y-1.5">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Support &amp; Handler Telephone</label>
              <input
                type="text"
            ...
            <div className="space-y-1.5">
              ...
              <span className="text-[12px] text-[var(--color-botanical-subtle)] block">Settlement lock active.</span>
            </div>

            <div className="space-y-1.5">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Primary Time Zone</label>
              <div className="relative">
                ...
                <span className="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-[var(--color-botanical-subtle)] text-[20px]">expand_more</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[var(--color-surface-lowest)] rounded-2xl p-6 sm:p-8 shadow-[0_4px_20px_-2px_rgba(46,36,30,0.04)] border border-[var(--color-botanical-border)] space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 rounded-2xl bg-[var(--color-surface-low)] flex flex-col justify-between gap-4 border border-[var(--color-botanical-border)]/60">
              <div className="space-y-1">
                ...
                <p className="text-[12px] text-[var(--color-botanical-muted)]">When active, customers can browse the storefront.</p>
              </div>
              <div className="flex items-center justify-between pt-2 border-t border-[var(--color-botanical-border)]/40">
                <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Current State</span>
                <button
                  type="button"
                  role="switch"
            ...
            <div className="p-4 rounded-2xl bg-[var(--color-surface-low)] flex flex-col justify-between gap-4 border border-[var(--color-botanical-border)]/60">
              <div className="space-y-1">
                ...
                <p className="text-[12px] text-[var(--color-botanical-muted)]">Allow customers to place checkout orders.</p>
              </div>
              <div className="flex items-center justify-between pt-2 border-t border-[var(--color-botanical-border)]/40">
                <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Current State</span>
                <button
            ...
            <div className="p-4 rounded-2xl bg-[var(--color-surface-low)] flex flex-col justify-between gap-4 border border-[var(--color-botanical-border)]/60">
              <div className="space-y-1">
                ...
                <p className="text-[12px] text-[var(--color-botanical-muted)]">Allow customers to build bespoke gifts in the builder.</p>
              </div>
              <div className="flex items-center justify-between pt-2 border-t border-[var(--color-botanical-border)]/40">
                <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Current State</span>
                <button
        ...
        <section className="bg-[var(--color-surface-lowest)] rounded-2xl p-6 sm:p-8 shadow-[0_4px_20px_-2px_rgba(46,36,30,0.04)] border border-[var(--color-botanical-border)] space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1.5">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Currency Display</label>
              <div className="px-4 py-2.5 bg-[var(--color-surface-container)] rounded-xl border border-[var(--color-botanical-border)] text-[14px] text-[var(--color-botanical-subtle)]">
                INR (₹) — lakh/crore grouping
              </div>
              <span className="text-[12px] text-[var(--color-botanical-subtle)] block">Not yet persisted — display only.</span>
            </div>
            <div className="space-y-1.5">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[var(--color-botanical-subtle)]">Date &amp; Time Format</label>
              <div className="px-4 py-2.5 bg-[var(--color-surface-container)] rounded-xl border border-[var(--color-botanical-border)] text-[14px] text-[var(--color-botanical-subtle)]">
          ...
          {/* Governance Notice */}
          <div className="p-4 rounded-xl bg-[var(--color-surface-low)] flex items-start gap-3 mt-4 border border-[var(--color-botanical-border)]/60">
            <span className="material-symbols-outlined text-[var(--color-botanical-subtle)] text-[20px] mt-0.5">info</span>
            <p className="text-[13px] text-[var(--color-botanical-muted)]">
              <strong className="text-[var(--color-botanical-primary)] font-semibold">Honest prototype note:</strong> only fields confirmed by the backend
